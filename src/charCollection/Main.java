...
public class Main {
    public static void main(String[] args)
    {
        ...
        System.out.println(abrakadabra1.size());
        System.out.println(abrakadabra1.count('R'));
        System.out.println(abrakadabra1.count('X'));
        System.out.println(abrakadabra1.different());
